...
if len(sys.argv) < 5:
    print "Usage: python nnet.py l h e <train_file> <test_file>"

lr, num_hidden, epochs, train_file, test_file = sys.argv[1:]
...
nn = NN(num_inputs, int(num_hidden), 1, float(lr), int(epochs))
nn.train(records)
